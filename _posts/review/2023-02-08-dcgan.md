...
![](_posts/review/images/3.DCGAN/1.DCGAN_Model.png)
...
![](./images/3.DCGAN/GAN_Model.png)

![](./images/3.DCGAN/이미지_분포.png)

![](./images/3.DCGAN/GAN_이론공식.png)
...
![](./images/3.DCGAN/gan-architecture.png)
...
![](./images/3.DCGAN/cnn-architecture.png)
...
![](./images/3.DCGAN/Architecture_guidelines.png)
...
![](./images/3.DCGAN/padding_strides.gif)
...
![](./images/3.DCGAN/padding_strides_transposed.gif)
...
![](./images/3.DCGAN/1.DCGAN_Model.png)
...
![](./images/3.DCGAN/8.Glasses.png)
![](./images/3.DCGAN/7.Smilling.png)
벡터 산술 연산을 통해 
